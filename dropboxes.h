...
const char* YawResolver[] =
{
	" Off" ,
	" Delta (memes)" ,
	" Experimental (wow)" ,
	" Anti freestanding(ish) (kinda)" 
};
...
const char* BuyBotNade[] =
{
	" Off" ,
	" 2xFlash, HE, Smoke" ,
	" Flash, HE, Smoke, Molly" 
};
const char* BuyBotArmor[] =
{
	" Off" ,
	" Kevlar" ,
	" Kevlar + Helmet" 
